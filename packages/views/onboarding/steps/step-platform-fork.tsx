 ...
 * machine for runtimes. This screen is a fan-out: two clearly clickable
 * cards, each with an explicit right-side button that says what clicking
 * does:
 *
 *   1. **Install the CLI** — primary card, "Show steps" pill → opens a
 ...
 *      (Skip / Cloud waitlist) — mirrors the web EmptyView, which
...
function CliWaitingStatus({ dialogOpen }: { dialogOpen: boolean }) {
  ...
  //   mirrors the web EmptyView — by that point
